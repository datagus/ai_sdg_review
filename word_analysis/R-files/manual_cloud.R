...
##----PUTTING THE WORDS AS INDEX----

#This function creates a new list with the articles-dataframes but putting the words as index
...
colores <- c("#800080","#008080","#0000FF","#800000","#808000","#FF00FF",
             "#008000","#FF0000","#000080","#FFA500","#A52A2A","#8B4513","#DC143C",
             "#DA70D6","#7FFF00","#D2691E","#00CED1","#9400D3","#FFD700","#ADFF2F","#FF69B4","#CD5C5C"
) #for conceptual
...
text(subsets[[1]]$DCA1[c(1)],subsets[[1]]$DCA2[c(1)], labels=rownames(subsets[[1]])[c(1)],col=colores[1],cex=1, font=2)
text(subsets[[1]]$DCA1[c(2)],subsets[[1]]$DCA2[c(2)], labels=rownames(subsets[[1]])[c(2)],col=colores[1],cex=1, font=2)
text(subsets[[1]]$DCA1[c(3)],subsets[[1]]$DCA2[c(3)]-0.2, labels=rownames(subsets[[1]])[c(3)],col=colores[1],cex=1, font=2)
text(subsets[[1]]$DCA1[c(4)],subsets[[1]]$DCA2[c(4)], labels=rownames(subsets[[1]])[c(4)],col=colores[1],cex=1,font=2)
text(subsets[[1]]$DCA1[c(5)]+0.1,subsets[[1]]$DCA2[c(5)]+0.2, labels=rownames(subsets[[1]])[c(5)],col=colores[1],cex=1, font=2)

text(subsets[[2]]$DCA1[c(1)],subsets[[2]]$DCA2[c(1)], labels=rownames(subsets[[2]])[c(1)],col=colores[2],cex=1,font=2)
text(subsets[[2]]$DCA1[c(2)],subsets[[2]]$DCA2[c(2)]+0.3, labels=rownames(subsets[[2]])[c(2)],col=colores[2],cex=1,font=2)
text(subsets[[2]]$DCA1[c(3)],subsets[[2]]$DCA2[c(3)]-0.3, labels=rownames(subsets[[2]])[c(3)],col=colores[2],cex=1,font=2)
text(subsets[[2]]$DCA1[c(4)],subsets[[2]]$DCA2[c(4)]+0, labels=rownames(subsets[[2]])[c(4)],col=colores[2],cex=1,font=2)
text(subsets[[2]]$DCA1[c(5)],subsets[[2]]$DCA2[c(5)]-0.2, labels=rownames(subsets[[2]])[c(5)],col=colores[2],cex=1,font=2)

text(subsets[[3]]$DCA1[c(1)],subsets[[3]]$DCA2[c(1)]-0.1, labels=rownames(subsets[[3]])[c(1)],col=colores[3],cex=1,font=2)
text(subsets[[3]]$DCA1[c(2)],subsets[[3]]$DCA2[c(2)]-0.1, labels=rownames(subsets[[3]])[c(2)],col=colores[3],cex=1,font=2)
text(subsets[[3]]$DCA1[c(3)],subsets[[3]]$DCA2[c(3)]-0.1, labels=rownames(subsets[[3]])[c(3)],col=colores[3],cex=1,font=2)
text(subsets[[3]]$DCA1[c(4)],subsets[[3]]$DCA2[c(4)], labels=rownames(subsets[[3]])[c(4)],col=colores[3],cex=1,font=2)
text(subsets[[3]]$DCA1[c(5)],subsets[[3]]$DCA2[c(5)], labels=rownames(subsets[[3]])[c(5)],col=colores[3],cex=1,font=2)
...
text(subsets[[4]]$DCA1[c(3)],subsets[[4]]$DCA2[c(3)], labels=rownames(subsets[[4]])[c(3)],col=colores[4],cex=1,font=2)
text(subsets[[4]]$DCA1[c(4)],subsets[[4]]$DCA2[c(4)], labels=rownames(subsets[[4]])[c(4)],col=colores[4],cex=1,font=2)
text(subsets[[4]]$DCA1[c(5)],subsets[[4]]$DCA2[c(5)]+0, labels=rownames(subsets[[4]])[c(5)],col=colores[4],cex=1,font=2)

text(subsets[[5]]$DCA1[c(1)],subsets[[5]]$DCA2[c(1)], labels=rownames(subsets[[5]])[c(1)],col=colores[5],cex=1,font=2)
text(subsets[[5]]$DCA1[c(2)],subsets[[5]]$DCA2[c(2)], labels=rownames(subsets[[5]])[c(2)],col=colores[5],cex=1,font=2)
text(subsets[[5]]$DCA1[c(3)],subsets[[5]]$DCA2[c(3)]+0, labels=rownames(subsets[[5]])[c(3)],col=colores[5],cex=1,font=2)
text(subsets[[5]]$DCA1[c(4)]-0,subsets[[5]]$DCA2[c(4)], labels=rownames(subsets[[5]])[c(4)],col=colores[5],cex=1,font=2)
text(subsets[[5]]$DCA1[c(5)],subsets[[5]]$DCA2[c(5)], labels=rownames(subsets[[5]])[c(5)],col=colores[5],cex=1,font=2)

text(subsets[[6]]$DCA1[c(1)],subsets[[6]]$DCA2[c(1)]-0.1, labels=rownames(subsets[[6]])[c(1)],col=colores[6],cex=1,font=2)
text(subsets[[6]]$DCA1[c(2)],subsets[[6]]$DCA2[c(2)], labels=rownames(subsets[[6]])[c(2)],col=colores[6],cex=1,font=2)
text(subsets[[6]]$DCA1[c(3)],subsets[[6]]$DCA2[c(3)], labels=rownames(subsets[[6]])[c(3)],col=colores[6],cex=1,font=2)
text(subsets[[6]]$DCA1[c(4)],subsets[[6]]$DCA2[c(4)]-0.11, labels=rownames(subsets[[6]])[c(4)],col=colores[6],cex=1,font=2)
text(subsets[[6]]$DCA1[c(5)],subsets[[6]]$DCA2[c(5)], labels=rownames(subsets[[6]])[c(5)],col=colores[6],cex=1,font=2)

text(subsets[[7]]$DCA1[c(1)],subsets[[7]]$DCA2[c(1)], labels=rownames(subsets[[7]])[c(1)],col=colores[7],cex=1,font=2)
text(subsets[[7]]$DCA1[c(2)],subsets[[7]]$DCA2[c(2)], labels=rownames(subsets[[7]])[c(2)],col=colores[7],cex=1,font=2)
text(subsets[[7]]$DCA1[c(3)],subsets[[7]]$DCA2[c(3)], labels=rownames(subsets[[7]])[c(3)],col=colores[7],cex=1,font=2)
text(subsets[[7]]$DCA1[c(4)],subsets[[7]]$DCA2[c(4)]+0.18, labels=rownames(subsets[[7]])[c(4)],col=colores[7],cex=1,font=2)
text(subsets[[7]]$DCA1[c(5)],subsets[[7]]$DCA2[c(5)], labels=rownames(subsets[[7]])[c(5)],col=colores[7],cex=1,font=2)
...
text(subsets[[8]]$DCA1[c(3)],subsets[[8]]$DCA2[c(3)], labels=rownames(subsets[[8]])[c(3)],col=colores[8],cex=1,font=2)
text(subsets[[8]]$DCA1[c(4)],subsets[[8]]$DCA2[c(4)], labels=rownames(subsets[[8]])[c(4)],col=colores[8],cex=1,font=2)
text(subsets[[8]]$DCA1[c(5)],subsets[[8]]$DCA2[c(5)]+.17, labels=rownames(subsets[[8]])[c(5)],col=colores[8],cex=1,font=2)

#-----plotting the dendodgram-----
...
#----getting the number of members in each branches of each cluster-----
#----ploting each individual cluster or subdendogram--
...
#identifying labels going branch by branch
cluster22 <- clusters[[2]][[2]]
cluster222 <- cluster22[[2]]
cluster2221 <- cluster222[[1]]
cluster22211 <- cluster2221[[1]]
plot(cluster22211)
plot(cluster22211[[1]])
labels(cluster22211[[1]])

#---dataframe with all the papers with their clusters and words-----
...
##---adding the ellipsis on top of the DCA plot----
